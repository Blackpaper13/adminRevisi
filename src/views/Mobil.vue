...
<script>
    ...
    export default {
        data: () => ({
            ...
            dialogDelete: false,
            search: '',
            items: ['Manager','Tukang Laps','Tukang Masak','Tukang Angkut','Tukang Salam'],
            headers: [
                {
                    text: 'Nama',
                    align: 'start',
                ...
                { text: 'Umur (tahun)', value: 'calories' },
                { text: 'Posisi', value: 'fat' },
                { text: 'Gaji (Rp)', value: 'carbs' },
                { text: 'Asal', value: 'protein' },
